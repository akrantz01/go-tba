...
// Get the status of a given team at their events for a given year
func ListTeamStatusAtEvents(team string, year int64, apiKey string, opts *RequestOptions) ([]responses.TeamEventStatus, int, error) {
