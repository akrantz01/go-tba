...
// Get a list of teams in an event
func ListTeamsInEvent(event, apiKey string, opts *RequestOptions) ([]responses.Team, int, error) {
	// Generate the request
	req := newRequest("/event/"+event+"/teams", apiKey, opts)
...
// Get a simplified list of teams in an event
func ListTeamsInEventSimple(event, apiKey string, opts *RequestOptions) ([]responses.TeamSimple, int, error) {
	// Generate the request
	req := newRequest("/event/"+event+"/teams/simple", apiKey, opts)
...
// Get a list of the keys for teams in an event
func ListTeamsInEventKey(event, apiKey string, opts *RequestOptions) ([]string, int, error) {
	// Generate the request
	req := newRequest("/event/"+event+"/teams/keys", apiKey, opts)
...
// Get a list of teams in a district
func ListTeamsInDistrict(district, apiKey string, opts *RequestOptions) ([]responses.Team, int, error) {
	// Generate the request
	req := newRequest("/district/"+district+"/teams", apiKey, opts)
...
// Get a simplified list of teams in a district
func ListTeamsInDistrictSimple(district, apiKey string, opts *RequestOptions) ([]responses.TeamSimple, int, error) {
	// Generate the request
	req := newRequest("/district/"+district+"/teams/simple", apiKey, opts)
...
// Get a list of the keys for teams in a district
func ListTeamsInDistrictKey(district, apiKey string, opts *RequestOptions) ([]string, int, error) {
	// Generate the request
	req := newRequest("/district/"+district+"/teams/keys", apiKey, opts)
